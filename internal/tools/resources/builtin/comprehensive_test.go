...
func TestFashionSearch(t *testing.T) {
	t.Run("missing query parameter", func(t *testing.T) {
		...
		tool := builtin_domain.NewFashionSearch(searcher)
	...
	t.Run("search returns error from searcher", func(t *testing.T) {
		...
		tool := builtin_domain.NewFashionSearch(errorSearcher)
...
func TestStyleRecommender(t *testing.T) {
	t.Run("missing required parameters", func(t *testing.T) {
		recommender := builtin_domain.NewMockAgentRecommender()
		tool := builtin_domain.NewAgentRecommender(recommender)
	...
	t.Run("recommender returns error", func(t *testing.T) {
		...
		tool := builtin_domain.NewAgentRecommender(errorRecommender)
...
func TestStyleRecommenderWithTrends(t *testing.T) {
	t.Run("get trends", func(t *testing.T) {
		recommender := builtin_domain.NewMockAgentRecommender()
		tool := builtin_domain.NewAgentRecommenderWithTrends(recommender)
...
func TestWeatherCheck(t *testing.T) {
	t.Run("missing location parameter", func(t *testing.T) {
		provider := builtin_domain.NewMockWeatherProvider()
		tool := builtin_domain.NewWeatherCheck(provider)
	...
	t.Run("provider returns error for current weather", func(t *testing.T) {
		...
		tool := builtin_domain.NewWeatherCheck(errorProvider)
...
func TestMockFashionSearcher(t *testing.T) {
	...
	t.Run("search without filters", func(t *testing.T) {
		items, err := searcher.Search(context.Background(), "dress", &types.FashionFilters{})
...
func TestMockWeatherProvider(t *testing.T) {
	...
	t.Run("get current weather", func(t *testing.T) {
		...
		if weather.Temperature != 22.0 {
			t.Errorf("Temperature = %v, want 22.0", weather.Temperature)
		}
		if weather.Condition != "sunny" {
			t.Errorf("Condition = %v, want sunny", weather.Condition)
		}
	})
...
// Testtypes.FashionFilters tests types.FashionFilters struct.
...
// Testtypes.BudgetRange tests types.BudgetRange struct.
func TestBudgetRange(t *testing.T) {
	t.Run("create budget range", func(t *testing.T) {
		budget := &types.BudgetRange{
			Min: 50.0,
			Max: 200.0,
		}
...
// Testtypes.OutfitSuggestion tests types.OutfitSuggestion struct.
func TestOutfitSuggestion(t *testing.T) {
	outfit := &types.OutfitSuggestion{
		Name:        "Casual Friday",
...
// Testtypes.AgentTrend tests types.AgentTrend struct.
func TestAgentTrend(t *testing.T) {
	trend := &types.AgentTrend{
...
func (m *MockFashionSearcher) Search(ctx context.Context, query string, filters *types.FashionFilters) ([]*types.FashionItem, error) {
	items := []*types.FashionItem{
		{
			ItemID:           "item-1",
			Name:             "Summer Dress",
			Brand:            "Brand A",
	...
	if filters.Category != "" {
		filtered := make([]*types.FashionItem, 0)
...
func (e *errorFashionSearcher) Search(ctx context.Context, query string, filters *types.FashionFilters) ([]*types.FashionItem, error) {
...
func (e *errorStyleRecommender) GetRecommendations(ctx context.Context, profile *types.AgentProfile) (*types.AgentRecommendation, error) {
	return nil, errors.New("recommendation failed")
}

// GetTrends returns an error.
func (e *errorStyleRecommender) GetTrends(ctx context.Context, season string) ([]*types.AgentTrend, error) {
...
func (e *errorWeatherProvider) GetCurrent(ctx context.Context, location string) (*types.WeatherData, error) {
	return nil, errors.New("weather check failed")
}

// GetForecast returns an error.
func (e *errorWeatherProvider) GetForecast(ctx context.Context, location string, days int) ([]*types.WeatherData, error) {
